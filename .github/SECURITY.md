...
This project is a dependency-free Python library (the `genetic_algorithm`
package). Note that user-supplied fitness plugins run arbitrary code by design:
treat any third-party plugin as untrusted input and review it before use.
Reports concerning unsafe handling of plugin inputs are in scope.
